...
const CursoVeranoForm = () => {
  ...
  return (
    <>
      <h1 style={{ color: 'orange', textAlign: 'center' }}>Curso De Verano</h1>
      <div style={{ display: 'flex', justifyContent: 'center', backgroundColor: '#D3D3D3', padding: '20px' }}>
        <Paper elevation={3} style={{ padding: '20px' }}>
          ...
          En las  vacacaiones  te ofrecemos un espacio seguro y diferente, grupos pequeños y actividades divertidas enfocadas en el desarrollo del lenguaje .
          </Typography>
...
export default CursoVeranoForm;
